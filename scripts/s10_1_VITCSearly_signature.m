...
% -------------------------------------------------------------------
% Train and validate VITCS-early, a stage-specific variant of VITCS trained 
% exclusively on the first five CS+ and CS- trials of the threat acquisition 
...
%
% This script runs the full VITCS-early pipeline, reusing the same
% shared routines as the main VITCS model (see s02, s03_1, s03_2, s05):
%   (1) training with 10-fold CV on the early-trial contrast images 
...
savedir = fullfile(basedir, 'results', 'VITCS_early_results');   % <-- if necessary, EDIT THIS
